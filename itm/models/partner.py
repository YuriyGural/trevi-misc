...
class ResPartner(models.Model):
    ...
    equipment_ids = fields.One2many("itm.equipment", "partner_id", "Assets", groups="itm.group_itm_user")
    equipment_count = fields.Integer(compute=_equipment_count, groups="itm.group_itm_user")
    access_ids = fields.One2many("itm.access", "partner_id", "Credentials", groups="itm.group_itm_user")
    access_count = fields.Integer(compute=_access_count, groups="itm.group_itm_user")
    backup_ids = fields.One2many("itm.backup", "partner_id", "Backups", groups="itm.group_itm_user")
